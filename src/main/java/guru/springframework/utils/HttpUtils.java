...
//                        continue;
//                    }
//                    sbParam.append(key + "=" + URLEncoder.encode(value, "utf-8") + "&");
...
//
////    @Override
////    public JSONObject getBannerList(Long tenantId){
////        TreeMap<String, String> queryParam = new TreeMap<String, String>();
////        queryParam.put("tenantId", tenantId + "");
////        try {
////            String responseStr = HttpUtils.get(serverEntity.getServerAddress() + "/banner/api/manage/list", null, queryParam);
